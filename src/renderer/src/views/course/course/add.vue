<template>
  <div>
    <el-form ref="formRef" :model="formData" :rules="rules" size="default" label-width="100px">
      <el-row gutter="15">
        <el-col :span="10">
          <el-form-item label="课程编号" prop="field106">
            <el-input v-model="formData.field106" type="text" placeholder="请输入课程编号" clearable
              :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <el-form-item label="课程学科" prop="field107">
            <el-select v-model="formData.field107" placeholder="请选择课程学科" clearable :style="{width: '100%'}">
      ...
      <el-row gutter="15">
        <el-col :span="10">
          <el-form-item label="适用人群" prop="field110">
            <el-select v-model="formData.field110" placeholder="请选择适用人群" clearable :style="{width: '100%'}">
        ...
        <el-col :span="10">
          <el-form-item label="课程有效期" prop="field111">
      ...
      <el-row gutter="15">
        <el-col :span="18">
          <el-form-item label="课程介绍" prop="field114">
            <el-input v-model="formData.field114" type="textarea" placeholder="请输入课程介绍"
